...
## Common Applications
Although the power method may often not be utilized because of its ability to only find the dominant eigenvalue and eigenvetor and because of its increased error amassed through its countless iterations, the power method is still used from some significant calculations which effect the day-to-day lives of many humans in the modern day. 
## References
